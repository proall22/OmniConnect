const features = [
  ...
  },
  {
    ...
    description: "Schedule and organize meetings efficiently.",
    icon: (
      <svg
        className="h-6 w-6"
        fill="none"
  ...
  },
  {
    ...
    description: "Track your growth and learning progress.",
    icon: (
      <svg
        className="h-6 w-6"
        fill="none"
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-xl text-gray-500 dark:text-gray-300">
            Our platform provides all the tools you need to manage your work
            effectively.
          </p>
        </div>
